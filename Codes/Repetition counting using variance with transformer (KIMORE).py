...
desired_activity_code = 2  # Change to your desired activity
desired_activity = 'Ex_' + str(desired_activity_code)

input_data_path = r"_path_to_joint_coordinates_data_...../Ex_" + str(desired_activity_code)


activitiesName = ['Ex_1', 'Ex_2', 'Ex_3', 'Ex_4', 'Ex_5' ]
...
def process_video(input_data, sub_no):
    ...
    noOfFrameSize = 16
    noOfFeatures  = 100
    lastLandmarkPoint = 25 
    
    
    motion_amplitude_threshold = 0.001
    ...
    if len(input_data) > 1:
                        ...
                        if frame_count > 2 and wait_idx <=0:  
                            ...
                            if len(autocorr) > 20:
                                ...
                                peaks, properties = find_peaks(
                                    autocorr,
                                    height= 0.3,  # Ensures height is at least 0
        ...
        print("Repetition count is : ", repetition_count)
